...
window.EventPoster = class EventPoster {
    ...
    cacheElements() {
        ...
        this.elements = {
            ...
            inputQrLeftUrl: document.getElementById('input-qr-left-url'),
            btnGenQrLeft: document.getElementById('btn-gen-qr-left'),
            qrLeftApiStatus: document.getElementById('qr-left-api-status'),
            ...
            inputQrRightUrl: document.getElementById('input-qr-right-url'),
            btnGenQrRight: document.getElementById('btn-gen-qr-right'),
            qrRightApiStatus: document.getElementById('qr-right-api-status'),
